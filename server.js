...
app.get('/api/seed', async (req, res) => {
    try {
        ...
        await User.insertMany([
            { name: 'Admin User', email: 'admin@example.com', phone: '1234567890', password: password, role: 'admin' },
            { name: 'John Doe', email: 'john@example.com', phone: '0987654321', password: password }
        ]);
